...
var _ParamsError = require('./ParamsError');
...
class Validator {
    ...
    contains(str, seed, msg = '', code = 12345) {
        if (!_validator2.default.contains(str, seed)) {
            msg = `字符串${str}中不包含字符串${seed}`;
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    equals(str, comparison, msg = 'equals: 参数校验失败', code = 12345) {
        if (!_validator2.default.equals(str, comparison)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isAfter(str, date, msg = '日期校验失败', code = 12345) {
        if (!_validator2.default.isAfter(str, date)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isBefore(str, date, msg = '日期校验失败', code = 12345) {
        if (!_validator2.default.isBefore(str, date)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isBoolean(str, msg = 'isBoolean: 参数校验失败', code = 12345) {
        if (!_validator2.default.isBoolean(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isCreditCard(str, msg = 'isCreditCard: 参数校验失败', code = 12345) {
        if (!_validator2.default.isCreditCard(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isEmail(str, msg = '邮箱地址不合法', code = 12345) {
        if (!_validator2.default.isEmail(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isNumeric(str, msg = '包含非数字', code = 12345) {
        if (!_validator2.default.isNumeric(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isURL(str, options = {}, msg = '地址不合法', code = 12345) {
        if (!_validator2.default.isURL(str, options)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isEmpty(str, msg = '字符串不为空', code = 12345) {
        if (!_validator2.default.isEmpty(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isIP(str, version, msg = 'IP 参数校验失败', code = 12345) {
        if (!_validator2.default.isIP(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isJSON(str, msg = 'JSON 字符串参数校验失败', code = 12345) {
        if (!_validator2.default.isJSON(str)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isLength(str, options, msg = '字符串长度校验失败', code = 12345) {
        if (!_validator2.default.isLength(str, options)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isUUID(str, version, msg = '校验失败，非 UUID 字符串', code = 12345) {
        if (!_validator2.default.isUUID(str, version)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
    ...
    isMobilePhone(str, locale = 'zh-CN', msg = '校验失败，非手机号', code = 12345) {
        if (!_validator2.default.isMobilePhone(str, locale)) {
            throw new _ParamsError2.default(code, msg);
        }
        return this;
    }
