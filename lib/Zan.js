...
var _rewrite = require('./middlewares/rewrite');
...
class Zan {
    ...
    get defaultConfig() {
        return {
            ...
            MIDDLEWARES_CONFIG_PATH: _path2.default.join(this.SERVER_ROOT, 'config/middlewares.js'),
            // iron 目录结构
            IRON_DIR: false,
            SRC_PATH: _path2.default.join(this.SERVER_ROOT, 'src')
        };
    }
    ...
    constructor(config) {
        ...
        if (this.NODE_ENV === 'development') {
            defaultServerRoot = _path2.default.join(process.cwd(), 'server');
        } else {
            defaultServerRoot = _path2.default.join(process.cwd(), 'server_dist');
        }
    ...
    loadProjectConfig() {
        ...
        this.projectConfig = (0, _defaultsDeep2.default)({}, envConfig, defaultConfig);
...
exports.rewrite = _rewrite2.default;
exports.middlewares = {
    code: _code2.default,
    body: _body2.default,
    koaStatic: _static2.default,
    ironRouter: _router6.default
};
